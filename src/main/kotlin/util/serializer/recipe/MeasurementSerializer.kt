...
//                    0 -> quantity = decodeDoubleElement(descriptor, index)
...
//                    1 -> measurementUnit = MeasurementUnit.fromString(decodeStringElement(descriptor, 4))
//                        ?: throw IllegalArgumentException("Invalid measurement unit: ${decodeStringElement(descriptor, 4)}")
//                    CompositeDecoder.DECODE_DONE -> break
//                    else -> error("Unexpected index: $index")
//                }
//            }
//            Measurement(quantity, measurementUnit)
//        }
//    }
//}